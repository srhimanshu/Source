...
public class Video_Prod_Env {
	...
	public void screen() throws Exception {
		...
		Video_Prod_Env eng = new Video_Prod_Env();
...
//		eng.click("(//i[@role='img'])[1]");
	...
	public void socialClick(Video_Prod_Env eng, WebDriverWait wait, String parent) throws InterruptedException {
	...
	public void clickButton(String Xpath, String parent, Video_Prod_Env eng) throws InterruptedException {
		eng.click(Xpath);
	...
	public void iframeClickWithStarFunctionality(String iframeXpath, Video_Prod_Env eng) throws InterruptedException {
		// Click on IFrame SAM
