...
public class Overlay_Stg_Env {
	...
	public void screen() throws Exception {
		...
		Overlay_Stg_Env eng = new Overlay_Stg_Env();
...
//		eng.click("(//i[@role='img'])[1]");
	...
	public void socialClick(Overlay_Stg_Env eng, WebDriverWait wait, String parent) throws InterruptedException {
	...
	public void clickButton(String Xpath, String parent, Overlay_Stg_Env eng) throws InterruptedException {
		eng.click(Xpath);
	...
	public void iframeClickWithStarFunctionality(String iframeXpath, Overlay_Stg_Env eng) throws InterruptedException {
		// Click on IFrame SAM
