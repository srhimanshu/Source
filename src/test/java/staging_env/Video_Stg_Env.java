...
public class Video_Stg_Env {
	...
	public void screen() throws Exception {
		...
		Video_Stg_Env eng = new Video_Stg_Env();
...
//		eng.click("(//i[@role='img'])[1]");
	...
	public void socialClick(Video_Stg_Env eng, WebDriverWait wait, String parent) throws InterruptedException {
	...
	public void clickButton(String Xpath, String parent, Video_Stg_Env eng) throws InterruptedException {
		eng.click(Xpath);
	...
	public void iframeClickWithStarFunctionality(String iframeXpath, Video_Stg_Env eng) throws InterruptedException {
		// Click on IFrame SAM
