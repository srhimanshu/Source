...
public class Overlay_Dev_Env {
	...
	public void setUp(String browser, String version, String platform ) throws Exception {
		...
		capabilities.setCapability("build", "Overlay");
	...
	public void screen() throws Exception {
		driver.get("https://experience-dev.sourcesync.io/517");

		wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		Overlay_Dev_Env eng = new Overlay_Dev_Env();
...
//		eng.click("(//i[@role='img'])[1]");
	...
	public void socialClick(Overlay_Dev_Env eng, WebDriverWait wait, String parent) throws InterruptedException {
	...
	public void clickButton(String Xpath, String parent, Overlay_Dev_Env eng) throws InterruptedException {
		eng.click(Xpath);
	...
	public void iframeClickWithStarFunctionality(String iframeXpath, Overlay_Dev_Env eng) throws InterruptedException {
		// Click on IFrame SAM
